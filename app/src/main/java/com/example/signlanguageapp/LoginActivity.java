...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isFirstTime) {
            // If it's the first time, save the preference and remain in LoginActivity
            SharedPreferences.Editor editor = preferences.edit();
            editor.putBoolean("isFirstTime", false);
            editor.apply();
            setContentView(R.layout.activity_login); // Load your login UI
        } else {
            // If it's not the first time, redirect to MainActivity
